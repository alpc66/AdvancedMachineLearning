...
# print("    svr Model")
# print("--------------------")
# predLin1 = svrModel(y_train)
# with open('tmp.txt', 'w') as f:
#     for each in predLin1:
#         f.write(str(each))
#         f.write('\n')
# #
f = open('result.txt', 'w')
with open('citation_test.txt', 'r') as f2:
    with open('tmp.txt', 'r') as f3:
        line1 = f2.readline()
        line2 = f3.readline()
        while line1 != '' and line2 != '':
            if line2.startswith('-'):
                line2 = '0'
            f.write(line1.split('\t')[0] + '\t' + line2.strip())
            f.write('\n')
            line1 = f2.readline()
            line2 = f3.readline()
f.close()
